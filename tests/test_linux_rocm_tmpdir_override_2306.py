...
# A whole-file byte-hash pin on the macOS/Windows bootstraps previously lived
# here, unrelated to this file's actual subject (the Linux ROCm DrumSep
# tmpdir preflight -- neither other platform implements it). It required
# manual re-pinning on every unrelated bootstrap change; removed rather than
# re-pinned again, since exact-file-identity was never the real contract.
