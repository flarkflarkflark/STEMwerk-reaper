...
local toolbarIcons = {
    {
        ...
        source150 = joinPath(toolbarAssetDir, "strips_135x45", "stemwerk_main_135x45.png"),
    ...
    },
    {
        ...
        source150 = joinPath(toolbarAssetDir, "strips_135x45", "stemwerk_setup_135x45.png"),
    ...
    },
    {
        ...
        source150 = joinPath(toolbarAssetDir, "strips_135x45", "stemwerk_karaoke_135x45.png"),
    ...
    },
    {
        ...
        source150 = joinPath(toolbarAssetDir, "strips_135x45", "stemwerk_vocals_only_135x45.png"),
    ...
    },
    {
        ...
        source150 = joinPath(toolbarAssetDir, "strips_135x45", "stemwerk_drums_only_135x45.png"),
    ...
    },
    {
        ...
        source150 = joinPath(toolbarAssetDir, "strips_135x45", "stemwerk_bass_only_135x45.png"),
    ...
    },
    {
        ...
        source150 = joinPath(toolbarAssetDir, "strips_135x45", "stemwerk_all_stems_135x45.png"),
    ...
    },
    {
        ...
        source150 = joinPath(toolbarAssetDir, "strips_135x45", "stemwerk_explode_takes_135x45.png"),
...
local function installToolbarIcons()
    ...
    for _, icon in ipairs(toolbarIcons) do
        ...
        local have150 = fileExists(icon.source150)
        local have2x = fileExists(icon.source2x)
        if not have1x or not have150 or not have2x then
            if not have1x then missing[#missing + 1] = icon.source1x end
            if not have150 then missing[#missing + 1] = icon.source150 end
            ...
            for _, name in ipairs(icon.targets) do
                ...
                local ok150, err150 = copyFile(icon.source150, joinPath(toolbar150, name))
...
if installOk then
    installSummary =
        ...
        "\n- 150%: matching names in 150/ (135x45 strips)" ..
    ...
    installSummary =
        ...
        toolbarAssetDir .. pathSep .. "strips_135x45\n" ..
