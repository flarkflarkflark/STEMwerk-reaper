...
- strips_135x45: REAPER toolbar 150% scale (3 states in one file: normal/hover/active)
- strips_180x60: REAPER toolbar hiDPI/retina (same 3-state layout at 2x)
- single/*: single-square icons (24, 30, 36, 45, 48, 60, 64) for manual/custom use
...
- 150% copies are installed with the same names under `Data/toolbar_icons/150/`.
