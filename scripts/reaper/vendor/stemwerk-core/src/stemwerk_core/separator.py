...
class StemSeparator:
    ...
    def separate(
        ...
        # audio-separator auto-detects MPS on Apple Silicon inside
        # setup_torch_device() and can ignore demucs_params["device"]. Force the
        # Separator back to CPU when the selected or fallback device is CPU.
